  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="客房名称" prop="kefangmingcheng">
              <el-input v-model="ruleForm.kefangmingcheng" 
                placeholder="客房名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="农家乐名称" prop="nongjialemingcheng">
          <el-input v-model="ruleForm.nongjialemingcheng" 
              placeholder="农家乐名称" clearable  :readonly="ro.nongjialemingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="农家乐名称" prop="nongjialemingcheng">
              <el-input v-model="ruleForm.nongjialemingcheng" 
                placeholder="农家乐名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="咨询电话" prop="zixundianhua">
              <el-input v-model="ruleForm.zixundianhua" 
                placeholder="咨询电话" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="环境评分" prop="huanjingpingfen">
          <el-select v-model="ruleForm.huanjingpingfen" placeholder="请选择环境评分">
            <el-option
                v-for="(item,index) in huanjingpingfenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="环境评分" prop="huanjingpingfen">
	      <el-input v-model="ruleForm.huanjingpingfen"
                placeholder="环境评分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.fuwupingfen"
                placeholder="服务评分" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="住宿评分" prop="zhusupingfen">
          <el-select v-model="ruleForm.zhusupingfen" placeholder="请选择住宿评分">
            <el-option
                v-for="(item,index) in zhusupingfenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="住宿评分" prop="zhusupingfen">
	      <el-input v-model="ruleForm.zhusupingfen"
                placeholder="住宿评分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="美食评分" prop="meishipingfen">
          <el-select v-model="ruleForm.meishipingfen" placeholder="请选择美食评分">
            <el-option
          ...
          <el-form-item class="input" label="手机" prop="shouji">
              <el-input v-model="ruleForm.shouji" 
                placeholder="手机" readonly></el-input>
                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                    <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="用户评价" prop="yonghupingjia">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.yonghupingjia" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yonghupingjia" label="用户评价" prop="yonghupingjia">
                    <span v-html="ruleForm.yonghupingjia"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	nongjialemingcheng : false,
	dizhi : false,
	zixundianhua : false,
	huanjingpingfen : false,
	fuwupingfen : false,
	zhusupingfen : false,
	meishipingfen : false,
	yonghupingjia : false,
	...
	shhf : false,
            ...
            ruleForm: {
                  ...
                  huanjingpingfen: [
                            { required: true, message: '环境评分不能为空', trigger: 'blur' },
                                    	                                                              ],
                  fuwupingfen: [
                            { required: true, message: '服务评分不能为空', trigger: 'blur' },
                                    	                                                              ],
                  zhusupingfen: [
                            { required: true, message: '住宿评分不能为空', trigger: 'blur' },
                                    	                                                              ],
                  meishipingfen: [
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.kefangmingcheng = true;
            continue;
	            	            ...
	            	            if(o=='nongjialemingcheng'){
            this.ruleForm.nongjialemingcheng = obj[o];
	    this.ro.nongjialemingcheng = true;
            continue;
          }
	            	            if(o=='dizhi'){
	    ...
	    this.ro.zixundianhua = true;
            continue;
	            	            ...
	            	            if(o=='huanjingpingfen'){
            this.ruleForm.huanjingpingfen = obj[o];
	    this.ro.huanjingpingfen = true;
            continue;
          }
	            	            if(o=='fuwupingfen'){
	    ...
	    this.ro.fuwupingfen = true;
            continue;
	            	            ...
	            	            if(o=='zhusupingfen'){
            this.ruleForm.zhusupingfen = obj[o];
	    this.ro.zhusupingfen = true;
            continue;
          }
	            	            if(o=='meishipingfen'){
	    ...
	    this.ro.meishipingfen = true;
            continue;
	            	            ...
	            	            if(o=='yonghupingjia'){
            this.ruleForm.yonghupingjia = obj[o];
	    this.ro.yonghupingjia = true;
            continue;
          }
	            	            if(o=='yonghuming'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                  ...
                                                                                                                  this.huanjingpingfenOptions = "1,2,3,4,5".split(',')
                                        this.fuwupingfenOptions = "1,2,3,4,5".split(',')
                                        this.zhusupingfenOptions = "1,2,3,4,5".split(',')
