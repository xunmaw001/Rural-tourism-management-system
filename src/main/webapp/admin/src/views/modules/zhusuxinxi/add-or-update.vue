  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.kefangzhuangtai"
                placeholder="客房状态" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="农家乐名称" prop="nongjialemingcheng">
          <el-select  @change="nongjialemingchengChange" v-model="ruleForm.nongjialemingcheng" placeholder="请选择农家乐名称">
            <el-option
                v-for="(item,index) in nongjialemingchengOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.nongjialemingcheng" label="农家乐名称" prop="nongjialemingcheng">
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                                            ...
                                                            // 下二随
    nongjialemingchengChange () {
      this.$http({
        url: `follow/nongjiale/nongjialemingcheng?columnValue=`+ this.ruleForm.nongjialemingcheng,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
                                                                                                                                                                                              if(data.data.leibie){
